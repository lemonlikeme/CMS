...
<div class="gif-section">
    <img src="https://www.ue.edu.ph/mla/wp-content/uploads/2022/09/propective_Studs_2022.gif" alt="Prospective Students 2022">
</div>

<!-- Columns_section -->
    <div class="two-columns">
        <div class="column">
            <?php echo '<p>Aimed to prepare our graduates to the modern globalizing knowledge society, information technology had permeated every nook of academic and administrative function in the University to make IT a way of life in the campus.</p>'; ?>
            <?php echo '<p>More than the state of the art IT infrastructure, modern facilities and equipment, air-conditioned classrooms, international linkages and renovated campus environment enhancing the academic ambiance, UE adopted Problem-Based Learning (PBL) thru Computer-Based Teaching (CBT) as its core competency in pursuit for academic excellence.</p>'; ?>
        </div>

        <div class="column">
            <?php echo '<p>As much as learning is a perpetual process, it is our mandate to continuously innovate our scholasticism to keep abreast with new trends or to revolutionize education.</p>'; ?>
            <?php echo '<p>Finally, being true to its mission in offering affordable quality education as envisioned by its founder, Mr. Francisco Dalupan, scholarships and study grants are available to poor but deserving students because UE kindles the light of hope to everyone who wants to succeed.</p>'; ?>
        </div>
    </div>
    </main>
